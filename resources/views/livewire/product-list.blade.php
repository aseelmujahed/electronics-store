<div class="max-w-7xl mx-auto py-6 px-2 sm:px-4 lg:px-8">
    ...
    <h2 class="text-3xl font-bold mb-8 text-center">{{ __('messages.all_products') }}</h2>
...
<div class="flex items-center justify-center mb-8 gap-2 w-full max-w-2xl mx-auto">
    @if($isArabic)
      <button
        ...
        <input
            ...
            class="border border-gray-300 rounded px-4 py-2 flex-1 shadow focus:outline-none focus:ring-2 focus:ring-blue-200 text-right"
            style="direction: rtl;"
        />
    @else
        <input
            ...
            wire:keydown.enter="doSearch"
            placeholder="{{ __('messages.search_placeholder') }}"
            class="border border-gray-300 rounded px-4 py-2 flex-1 shadow focus:outline-none focus:ring-2 focus:ring-blue-200 text-left"
        />
         <button
            wire:click="doSearch"
            class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 rounded shadow transition w-32">
    ...
    <div class="text-center text-gray-400 py-10 text-lg">
        {{ __('messages.no_search_products') }}
    </div>
    @endif
